...
echo string is "curl -X POST $GO _SERVER_RESTURL/properties/$GO_PIPELINE_NAME/$GO_PIPELINE_COUNTER/$GO_STAGE_NAME/$GO_STAGE_COUNTER/$GO_JOB_NAME/ipaddress -k -H 'Authorization: Basic ZGVwbG95ZXI6ZGVwbEB5ZXItR29DRA==' -H 'Confirm: true' -H 'Postman-Token: 04fe747a-6352-4388-acb9-5e01492fc787' -H 'cache-control: no-cache' -d 'value=123'"


curl -X POST $GO _SERVER_RESTURL/properties/$GO_PIPELINE_NAME/$GO_PIPELINE_COUNTER/$GO_STAGE_NAME/$GO_STAGE_COUNTER/$GO_JOB_NAME/ipaddress -k -H 'Authorization: Basic ZGVwbG95ZXI6ZGVwbEB5ZXItR29DRA==' -H 'Confirm: true' -H 'Postman-Token: 04fe747a-6352-4388-acb9-5e01492fc787' -H 'cache-control: no-cache' -d 'value=123'
